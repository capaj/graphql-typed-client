...
export abstract class Type {
  ...
  get ofType() {
    return this.data.ofType && this.schema.resolveType(this.data.ofType)
  }
  ...
  get inputFields(): Argument[] {
    return []
  }

  get enumValues(): { name: string }[] {
    return []
  }
